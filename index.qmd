...
subtitle: |
  ...
  <br>{{< env ATELIER_LABEL >}}_^0.9.1^<br>
  *Wolfgang Spahn*
  <br><br>
  10.09.2026
  <br>
...
<br>
<div class="centered-xxl-text"> [{{< env ATELIER_URL >}}]({{< env ATELIER_URL >}}) </div>
<br>
...
- **KI Status 2026 ([I](#i.))** <span class="red">^15min^</span>
  - KI etabliert sich
  - KI verändert die Schule ^🞋[[Zeitenwende]](#zeitenwende)^ 

- **Lernen und Lehren mit/trotz Künstlicher Intelligenz ([II](#ii.))** <span class="red">^45min^</span>
...
- **KI Lerntechnologien ([III](#iii.))** <span class="red">^opt^</span>
...
![ChatGPT: KI hilft](images/erweiteres_denken_mit_KI.png){width="80%"}
:::
::::
<!-- --------------------------------------------------- slide ----------------------------------------------------- -->
## Zeitenwende 🞋
...
- <span class="blue">**Denkmaschinen:**</span> Nehmen uns das Denken ab, aber man muss nun ....
  * <span class="blue">**KI steuern, kritisch überwachen und Fehlersituationen auflösen**</span> können.
:::
...
:::{.text-sm}
@newmann1996authentic, @bransford2000howpeoplelearn
:::
<!-- ------------------------------------------------- slide ----------------------------------------------------- -->
...
<div type="inputField" id="inputFieldRFA"></div>
<div type="inputCollection" ref="inputFieldRFA" argConfig='{ "width": 500, "height": 400, "hidden": false }'></div>
...
<div type="inputField" id="inputFieldRFB"></div>
<div type="inputCollection" ref="inputFieldRFB" argConfig='{ "width": 500, "height": 400, "hidden": false }'></div>
